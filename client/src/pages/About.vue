<template>
  <q-page class="page-about">
		...
		<p>
			Chaos Archives is part of the <a href="https://discord.gg/ffxiv-chaos-rp" target="_blank">FFXIV Chaos RP Community <q-icon name="discord" /></a>. Feel free to join us on Discord!
		</p>
		<h3>Credits</h3>
		<dl>
