...
const TINYMCE_OPTIONS = {
  ...
  skin: 'tinymce-5',
  toolbar:
    'restoredraft undo redo | blocks | bold italic | \
    alignleft aligncenter alignright | \
    image gallery upload link | bullist numlist | removeformat',
  toolbar_mode: 'wrap',
  toolbar_persist: true,
  menu: {
    edit: { title: 'Edit', items: 'restoredraft | undo redo | cut copy paste | selectall | searchreplace' },
  ...
  private onHideDetailsClick(editor: TinyMceEditor) {
    editor.undoManager.transact(() => {
      ...
      editor.selection.setContent(
        `<section class="hide-details hide-details_visible"><div class="hide-details__title">[insert title here]</div><div class="hide-details__content">${
